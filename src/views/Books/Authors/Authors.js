...
export default class Users extends React.Component {
  ...
  fetchData = async () => {
    await axios.get(`http://localhost:5000/api/author/all?limit=10&page=1`).then(res => {
        ...
        <div className="animated fadeIn">
          <Row>
            <Col xl={12}>
              <Card>
                <CardHeader>
                  <i className="fa fa-align-justify"></i> Authors <small className="text-muted">example</small>
                </CardHeader>
                <CardBody>
